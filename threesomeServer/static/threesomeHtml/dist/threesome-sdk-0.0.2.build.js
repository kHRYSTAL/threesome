 ...
 * @returns
 */
function setBackButtonStyleType(navBtnType) {
 ...
 * @returns
 */
function setCloseTextFontColor(color) {
...
function showTxtRightButton(params, handlerFunc) {
 ...
 * @param {Function} callback
 */
function setNavigationBarBackgroundImage(imageType) {
 ...
 * @param {Function} callback
 */
function setStatusBarStyletype(style) {
...
var api = Object.freeze({
	...
	setBackButtonStyleType: setBackButtonStyleType,
	setCloseTextFontColor: setCloseTextFontColor,
	...
	setStatusBarStyletype: setStatusBarStyletype
});
...
//# sourceMappingURL=threesome-sdk-0.0.2.build.js.map
